...
<link rel="stylesheet" href="/src/css/kitchen_styles.css"> 
...
<div class="main-container">
    <aside class="sidebar">
        <div>
            ...
            <ul>
                <li>
                    <a href="/src/php/kitchen_orders.php" class="active">
                        <i class="fas fa-list-alt"></i> Órdenes de Cocina
                    </a>
                </li>
                <li>
                    <a href="/src/php/kitchen_history.php">
...
<script src="/src/js/kitchen_logic.js"></script>
</body>
</html>
